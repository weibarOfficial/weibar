...
public enum ErrorCodeEnum {
    ...
    USER_USER_ID_EXIST_MORE(-10014,"userId 存在多条记录"),
    USER_ERROR_END(-20000,"用户相关错误结束段"),

    MERCHANT_ERROR_BEGIN(-20001,"商户相关错误开始段"),
    MERCHANT_MERCHANT_ID_NOT_EXIST(-20002,"商户ID不存在"),
    MERCHANT_MERCHANT_SHARE_ERROR(-20003,"商户分成比例不正确，下属机构分成比例不能超过上层"),
    MERCHANT_MERCHANT_NAME_EXIST(-20004,"商户名已存在"),
    MERCHANT_MERCHANT_AGENT_ID_NOT_EXIST(-20005,"代理商ID不存在"),
    MERCHANT_MERCHANT_NAME_NOT_EXIST(-20006,"商户名不存在"),
    MERCHANT_MERCHANT_PWD_OR_NAME_ERROR(-20007,"账户名或密码错误"),
    MERCHANT_MERCHANT_SHARE_TOO_SMALL(-20008,"分成比例不能小于0"),
    MERCHANT_MERCHANT_PWD_CONFIRM_ERROR(-20009,"两次输入的新密码不一致"),
